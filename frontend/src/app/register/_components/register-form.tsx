          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 shadow-sm">
              ...
              <div className="space-y-1 leading-none">
                <FormLabel>
                  আমি এই মর্মে অঙ্গীকার করছি যে "BYSO ইফতার মাহফিল ২০২৬" অনুষ্ঠানে সংগঠনের সকল নীতিমালা ও শৃঙ্খলা মেনে চলব এবং সেগুলোর প্রতি সর্বোচ্চ সম্মান প্রদর্শন করব।এবং আয়োজক কমিটির দিক নির্দেশনা মোতাবেক অনুষ্ঠানটিতে অংশগ্রহণ করবো।
                </FormLabel>
              </div>
            </FormItem>
          )}
