        ...
        <div className="flex justify-center items-center py-12">
            <Card className="w-full max-w-lg">
                <CardHeader className="text-center">
                    ...
                    <Alert variant="destructive" className="text-left border-2 border-red-600">
                        <AlertTriangle className="h-4 w-4 text-red-600" />
                        <AlertTitle className="text-red-600 font-bold">গুরুত্বপূর্ণ নোটিশ / Important Notice</AlertTitle>
                        <AlertDescription className="text-red-600 font-bold space-y-2">
                            <p>
                                পেমেন্ট অ্যাপ্রুভ না হওয়া পর্যন্ত অপেক্ষা করুন। আমরা আপনার ট্রানজেকশন আইডি চেক করে মিলিয়ে দেখার পর অ্যাপ্রুভ করব এবং আপনার টিকিট অটো জেনারেট হবে। ততক্ষণ ধৈর্য ধরুন।
                            </p>
                            <p>
